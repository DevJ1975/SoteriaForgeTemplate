...
const lessonSchema = new Schema(
  {
    ...
    passingScore: Number,
    attemptLimit: Number,
    languageVariants: { type: [String], default: [] },
    vimeoUrl: String,
    assetId: { type: Schema.Types.ObjectId, ref: 'Asset' },
    studyGuideAssetId: { type: Schema.Types.ObjectId, ref: 'Asset' },
    quizQuestions: [
      {
        id: String,
        prompt: String,
  ...
  new Schema(
    {
      ...
      complianceDisclaimers: { type: [String], default: [] },
      contactHourTargetMinutes: Number,
      sequenceLocked: { type: Boolean, default: false },
      passingScore: Number,
      attemptLimit: Number,
      languageVariants: { type: [String], default: [] },
      studyGuideAssetId: { type: Schema.Types.ObjectId, ref: 'Asset' },
